...
__all__ = [
    'SPEI_VOICE_CHANGE', 'SPEI_RESERVED2', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechObjectTokens', 'SPAUDIOOPTIONS',
    'SAFT16kHz16BitStereo', 'SREAdaptation', 'SVEStartInputStream',
    'DISPID_SPIGetText', 'STCInprocServer', 'ISpeechLexiconWord',
    'DISPID_SPEAudioSizeBytes', 'eLEXTYPE_PRIVATE13',
    'SPEI_SR_RETAINEDAUDIO', 'SVP_3', 'SPCT_DICTATION',
    'SPXRO_Alternates_SML', 'DISPID_SRGDictationSetState',
    'DISPID_SVSpeakStream', 'SpeechRegistryLocalMachineRoot',
    'SpeechUserTraining', 'DISPID_SpeechPhraseElement',
    'ISpeechMMSysAudio', 'SDKLCurrentConfig',
    'DISPID_SPEAudioSizeTime', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRRTLength', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechRetainedAudioOptions',
    'SDTAudio', 'DISPID_SVAudioOutput', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPIRule', 'SRAORetainAudio', 'eLEXTYPE_PRIVATE10',
    'SPRS_INACTIVE', 'SpeechDictationTopicSpelling',
    'tagSPPROPERTYINFO', 'DISPID_SPRuleParent',
    'SpeechRecognitionType', 'SAFTCCITT_ALaw_44kHzMono',
    'SRCS_Disabled', 'SAFT24kHz16BitMono',
    'DISPID_SPIEnginePrivateData', 'DISPID_SDKSetStringValue',
    'SVESentenceBoundary', 'ISpeechRecoContext', 'ISpeechGrammarRule',
    'SPWORDLIST', 'SGDSActiveWithAutoPause', 'SPAS_STOP',
    'SPVPRI_OVER', 'DISPID_SRGRules', 'SVP_10', 'SPPHRASE',
    'DISPID_SpeechPhraseProperty', 'DISPID_SGRAttributes',
    'ISpeechPhraseElement', 'DISPID_SRCVoicePurgeEvent',
    'SpPhoneticAlphabetConverter', 'ISpeechPhraseRules', 'ISpDataKey',
    'SAFT8kHz8BitMono', 'DISPID_SRCRecognizer', 'SRTSMLTimeout',
    'SFTSREngine', 'DISPID_SLWWord', 'SP_VISEME_0',
    'DISPID_SPPFirstElement', 'DISPID_SRGDictationUnload',
    'DISPID_SMSALineId', 'SRTReSent', 'ISpeechPhraseAlternates',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRDisplayUI', 'DISPID_SDKDeleteValue',
    'eLEXTYPE_PRIVATE17', 'SPRULESTATE', 'ISpeechVoiceStatus',
    'ISpeechDataKey', 'SSFMCreateForWrite', 'SRTStandard',
    'SP_VISEME_13', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpMMAudioOut',
    'DISPID_SVSpeak', 'DISPID_SDKEnumValues', 'ISpeechObjectTokens',
    'STSF_CommonAppData', 'DISPID_SRSSupportedLanguages',
    'SPSHT_EMAIL', 'DISPIDSPTSI_ActiveLength', 'SRATopLevel',
    'DISPID_SpeechMMSysAudio', 'DISPID_SWFEChannels',
    'SpeechSpecialTransitionType', 'DISPID_SBSFormat',
    'SpeechPropertyAdaptationOn', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRGetFormat', 'DISPID_SPAs_NewEnum', 'DISPID_SLPsCount',
    'DISPID_SPRsCount', 'DISPID_SLPType', 'ISpNotifyTranslator',
    'DISPID_SpeechFileStream', 'DISPID_SRSClsidEngine',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SOTCreateInstance',
    'SpeechAudioFormatGUIDText', 'SAFT11kHz8BitStereo',
    'SPSSuppressWord', 'SVSFPersistXML', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRStatus', 'SPSInterjection', 'DISPID_SLPsItem',
    'DISPID_SpeechRecoResult', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SMSADeviceId', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPAR_Unknown', 'ISpRecoContext', 'ISpeechRecoResultDispatch',
    'SAFTGSM610_22kHzMono', 'DISPID_SGRsAdd', 'SRSActive',
    'DISPID_SRAudioInputStream', 'DISPID_SPPsCount',
    'SAFT11kHz16BitMono', 'DISPID_SRCState', 'SPCS_DISABLED',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SOTCDefault',
    'SPDKL_DefaultLocation', 'SAFT22kHz16BitMono', 'SPAR_Low',
    'DISPID_SGRsItem', 'SPPHRASEREPLACEMENT',
    'DISPID_SRCEventInterests', 'SPRECORESULTTIMES',
    'DISPID_SRGDictationLoad', 'SpTextSelectionInformation',
    'SpLexicon', 'SPEVENTENUM', 'SPWT_PRONUNCIATION',
    'SSSPTRelativeToEnd', 'DISPID_SGRSAddRuleTransition',
    'SREStreamEnd', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechLexicon',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SVStatus', 'DISPID_SVResume',
    'SRSInactiveWithPurge', 'SPLEXICONTYPE', 'SRESoundEnd',
    'SWPUnknownWordPronounceable', 'SPGS_EXCLUSIVE', 'SPCS_ENABLED',
    'DISPID_SPRText', 'SP_VISEME_20', 'SPPS_Noncontent',
    'DISPID_SPARecoResult', 'DISPID_SRSCurrentStreamNumber',
    'Speech_StreamPos_RealTime', 'SpeechVoiceSkipTypeSentence',
    'eLEXTYPE_PRIVATE11', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SGRs_NewEnum', 'ISpeechObjectTokenCategory',
    'DISPID_SLPSymbolic', 'SVSFParseMask', 'ISpRecoResult',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SRRecognizer',
    'SPPS_Modifier', 'DISPID_SpeechMemoryStream',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPPName',
    'SpeechCategoryRecognizers', 'SPPS_RESERVED4',
    'DISPID_SRCBookmark', 'DISPID_SPRFirstElement', 'SVSFUnusedFlags',
    'SVP_2', 'DISPID_SMSAMMHandle', 'DISPID_SGRSTPropertyId',
    'DISPID_SpeechGrammarRuleState', 'SP_VISEME_11',
    'DISPID_SRGRecoContext', 'DISPIDSPTSI_SelectionLength',
    'SVSFParseSapi', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SLGetGenerationChange', 'ISpVoice',
    'ISpeechLexiconPronunciation', 'DISPID_SOTMatchesAttributes',
    'DISPID_SDKCreateKey', 'DISPID_SAEventHandle', 'SPRULE',
    'SAFTADPCM_8kHzMono', 'SPRECOSTATE',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRGCmdLoadFromFile',
    'SPSNoun', 'DISPID_SVEStreamEnd', 'SPFM_CREATE_ALWAYS', 'SLTUser',
    'DISPID_SASNonBlockingIO', 'SPAUDIOSTATE',
    'SDA_Two_Trailing_Spaces', 'ISpeechAudioStatus', 'SDTProperty',
    ...
    'DISPID_SRCVoice', 'DISPID_SVAlertBoundary',
    'DISPID_SPRules_NewEnum', 'DISPID_SPIEngineId', 'STSF_AppData',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SGRName',
    'eLEXTYPE_LETTERTOSOUND', 'SRAONone', 'DISPID_SGRsDynamic',
    'SAFT48kHz16BitStereo', 'SDTReplacement',
    'DISPID_SOTIsUISupported', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPADAPTATIONRELEVANCE', 'SP_VISEME_8', 'SGSDisabled',
    'SPGRAMMARSTATE', 'SP_VISEME_5', 'DISPID_SOTCGetDataKey',
    'DISPID_SpeechLexiconWords', 'DISPID_SRRGetXMLResult',
    'SVSFDefault', 'SAFTGSM610_8kHzMono', 'SSTTDictation',
    'SP_VISEME_18', 'DISPID_SVSyncronousSpeakTimeout',
    'SAFT8kHz16BitStereo', 'SREPropertyStringChange',
    'DISPID_SVPause', 'STCRemoteServer', 'SPSUnknown', 'SVP_5',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechRecognizerState', 'SVEPhoneme',
    'SITooSlow', 'SPWORD', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SPRulesCount', 'DISPID_SVSInputWordLength',
    'SpeechPropertyResourceUsage', 'DISPID_SRCEStartStream',
    'SPWT_LEXICAL', 'DISPID_SOTId', 'DISPID_SVEAudioLevel',
    'SVEWordBoundary', 'WAVEFORMATEX', 'SAFTCCITT_uLaw_8kHzStereo',
    'SREStreamStart', 'ISpRecognizer', 'DISPID_SPIElements',
    'SRTEmulated', 'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRState',
    'SVP_18', 'SpeechAudioFormatType', 'SPDKL_CurrentUser',
    'SDKLDefaultLocation', 'DISPID_SPAsCount', 'ISpeechCustomStream',
    'ISpeechRecoResultTimes', 'DISPID_SPRNumberOfElements',
    'ISpNotifySink', 'DISPID_SFSOpen',
    'DISPID_SPANumberOfElementsInResult', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SOTSetId', 'ISpEventSource', 'DISPID_SVGetAudioOutputs',
    'SPAR_Medium', 'DISPID_SDKSetLongValue', 'SVEAudioLevel',
    'eLEXTYPE_USER', 'SPEI_RECOGNITION', 'ISpObjectToken',
    'ISpObjectTokenCategory', 'SSTTTextBuffer',
    ...
    'STCInprocHandler', 'SPEI_SR_BOOKMARK', 'ISpeechRecognizerStatus',
    'ISpNotifySource', 'ISpStreamFormatConverter',
    'DISPID_SOTGetAttribute', 'ISpeechPhraseProperties',
    'ISpeechPhraseReplacement', 'DISPID_SGRsFindRule',
    'DISPID_SPRulesItem', 'SpeechVisemeFeature', 'DISPID_SMSSetData',
    'SGLexicalNoSpecialChars', 'SPSFunction', 'SAFT16kHz8BitMono',
    'SPSLMA', 'SREPrivate', 'SPRECOCONTEXTSTATUS', 'SVSFIsFilename',
    'SP_VISEME_4', 'SpeechRuleAttributes', 'SITooFast',
    'DISPID_SRCESoundStart', 'DISPID_SGRAddResource', 'SPEI_VISEME',
    'DISPID_SGRSTs_NewEnum', 'SPVOICESTATUS',
    'SpeechCategoryAppLexicons', 'DISPID_SPEDisplayText',
    'SpeechCategoryAudioIn', 'DISPID_SOTCEnumerateTokens',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRCResume',
    'SPPS_RESERVED1', 'ISpRecognizer3', 'SVP_11',
    '_ISpeechVoiceEvents', 'SPSModifier', 'SPAO_NONE',
    'DISPID_SVEStreamStart', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SGRSTPropertyName', 'SECFIgnoreKanaType',
    'DISPID_SPERetainedSizeBytes', 'SP_VISEME_10', 'DISPID_SOTsCount',
    'DISPID_SPCLangId', 'SPWORDPRONOUNCEABLE', 'DISPID_SABIEventBias',
    'SINone', 'SAFTADPCM_44kHzMono', 'ISpRecoGrammar',
    'SPINTERFERENCE_TOOQUIET', 'ISpRecoContext2',
    'DISPID_SRGCmdSetRuleState', 'SpeechDiscardType',
    'DISPID_SpeechRecoResultTimes', 'SVEViseme', 'SPAUDIOSTATUS',
    'eLEXTYPE_PRIVATE1', 'ISequentialStream', 'SDTLexicalForm',
    'SDTPronunciation', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPIProperties', 'SPEI_UNDEFINED',
    'DISPID_SpeechPhraseAlternate', 'SPRST_ACTIVE_ALWAYS',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SGRSTWeight',
    'DISPID_SpeechPhraseProperties', 'DISPID_SpeechGrammarRule',
    'DISPID_SLPs_NewEnum', 'SpSharedRecognizer',
    'DISPID_SGRInitialState', 'SAFT12kHz16BitMono',
    'SAFT22kHz8BitMono', 'SPFM_OPEN_READONLY', 'SPAUDIOBUFFERINFO',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRCEEndStream',
    'DISPID_SpeechObjectToken', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SLRemovePronunciation', 'SP_VISEME_15',
    'SpeechWordPronounceable', 'SREAudioLevel', 'SRTExtendableParse',
    'SREPhraseStart', 'SAFT24kHz8BitMono', 'eLEXTYPE_PRIVATE3',
    'SPRST_ACTIVE', 'SPAS_PAUSE', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVVoice', 'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRIsShared',
    'DISPID_SLPLangId', 'SAFTADPCM_8kHzStereo',
    'DISPID_SVGetProfiles', 'SAFTCCITT_ALaw_11kHzMono', 'SpMMAudioIn',
    'DISPID_SRGetPropertyNumber', 'ISpeechLexiconWords',
    'SVSFIsNotXML', 'DISPID_SRCEPropertyStringChange',
    'SPSERIALIZEDRESULT', 'DISPID_SPEsCount', 'ISpeechWaveFormatEx',
    'DISPID_SVEPhoneme', 'DISPID_SGRSRule', 'ISpPhraseAlt',
    'DISPID_SPRsItem', 'SREFalseRecognition',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechTokenContext',
    'DISPID_SBSRead', 'DISPID_SPILanguageId', 'SAFT44kHz8BitMono',
    'SPWT_DISPLAY', 'DISPID_SPRDisplayAttributes',
    'ISpeechAudioFormat', 'SPVISEMES', 'DISPID_SRGState',
    'SAFT32kHz8BitStereo', 'DISPID_SpeechVoice', 'eWORDTYPE_DELETED',
    'SVEEndInputStream', 'ISpeechPhraseInfo', 'SPEI_PHONEME',
    'DISPID_SVVolume', 'SASPause', 'SAFTADPCM_44kHzStereo',
    'DISPID_SABIMinNotification', 'ISpeechRecoResult',
    'DISPID_SPRs_NewEnum', 'DISPID_SBSSeek', 'IEnumSpObjectTokens',
    'SPEI_END_INPUT_STREAM', 'SECHighConfidence', 'ISpStream',
    'SVP_15', 'DISPID_SDKGetBinaryValue', 'SPSERIALIZEDPHRASE',
    'DISPID_SVSLastStreamNumberQueued', 'eLEXTYPE_RESERVED10',
    'DISPID_SDKOpenKey', 'DISPID_SRCEPhraseStart',
    'DISPID_SRRAlternates', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SVGetAudioInputs', 'SDTDisplayText',
    'DISPID_SRRAudioFormat', 'DISPID_SPRuleName',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'UINT_PTR',
    'SpUnCompressedLexicon', 'IInternetSecurityMgrSite',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRCESoundEnd',
    'SpeechAudioState', 'DISPID_SGRSTText', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechLexiconProns', 'IEnumString',
    'Speech_Max_Pron_Length', 'STCLocalServer', 'SRSActiveAlways',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechLoadOption',
    'DISPID_SPIAudioSizeBytes', 'SGLexical', 'DISPID_SDKEnumKeys',
    'DISPID_SVIsUISupported', 'SRSInactive', 'SPPS_RESERVED2',
    'SASRun', 'DISPID_SPPValue', 'DISPID_SAFGetWaveFormatEx',
    'SPEI_RESERVED6', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPCIdToPhone',
    'SPEI_TTS_PRIVATE', 'ISpStreamFormat', 'SDKLCurrentUser',
    'SPSTREAMFORMATTYPE', 'SPXRO_SML', 'SVF_Emphasis',
    'DISPID_SPISaveToMemory', 'SPDKL_CurrentConfig',
    'SpeechTokenShellFolder', 'SAFT12kHz8BitStereo', 'SPEI_SOUND_END',
    'DISPID_SRRTTickCount', 'SVP_7', 'SAFT32kHz16BitMono',
    'SPSHT_NotOverriden', 'eLEXTYPE_PRIVATE4', 'SPEI_START_SR_STREAM',
    'ISpRecognizer2', 'SPEI_WORD_BOUNDARY',
    'DISPID_SVSCurrentStreamNumber', 'SpeechVoiceSpeakFlags',
    'SPSHORTCUTTYPE', 'SVSFIsXML', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_RESERVED9', 'DISPID_SRCreateRecoContext',
    'SpeechVoicePriority', 'DISPID_SLWType', 'ISpeechPhoneConverter',
    'SPSHORTCUTPAIR', 'SPRECOGNIZERSTATUS', 'eLEXTYPE_RESERVED6',
    'SRSEDone', 'SAFT24kHz8BitStereo', 'SVEVoiceChange',
    'DISPID_SPEPronunciation', 'SpeechDataKeyLocation',
    'DISPID_SVEEnginePrivate', 'DISPID_SVSRunningState',
    'DISPID_SPIAudioStreamPosition', 'SAFT24kHz16BitStereo',
    'DISPID_SRRSaveToMemory', 'SPCONTEXTSTATE', 'SVP_1',
    'SpeechCategoryRecoProfiles', 'SPPHRASERULE',
    'eLEXTYPE_USER_SHORTCUT', 'SPPROPERTYINFO',
    'SAFT44kHz16BitStereo', 'DISPID_SRRSetTextFeedback',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPIGrammarId',
    'ISpeechFileStream', 'SGSExclusive', 'DISPID_SRCEAudioLevel',
    'DISPID_SPELexicalForm', 'ISpObjectWithToken', 'SP_VISEME_21',
    'DISPID_SRRTStreamTime', 'SpeechRuleState', 'SPPS_Function',
    'SpNullPhoneConverter', 'SpNotifyTranslator',
    'DISPID_SWFEBlockAlign', 'ISpEventSink', 'DISPID_SMSGetData',
    'SAFT11kHz16BitStereo', 'ISpeechPhraseReplacements', 'SPWF_INPUT',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRGCommit',
    'SPPS_NotOverriden', 'DISPID_SRCEAdaptation',
    'DISPID_SVSVisemeId', 'DISPID_SRCEFalseRecognition',
    'DISPID_SASState', 'SPDKL_LocalMachine',
    ...
    'SpeechVisemeType', 'SpeechGrammarWordType', 'SpeechLexiconType',
    'SAFTADPCM_22kHzMono', 'SRERequestUI', 'DISPID_SVWaitUntilDone',
    'SPEI_MIN_SR', 'ISpResourceManager', 'SVP_19', 'SRSEIsSpeaking',
    'SP_VISEME_17', 'SPFILEMODE', 'DISPID_SGRClear', 'SP_VISEME_1',
    'DISPID_SGRSTType', 'eLEXTYPE_RESERVED4', 'SECFEmulateResult',
    '__MIDL_IWinTypes_0009', 'IInternetSecurityManager', 'SVP_8',
    'SpInProcRecoContext', 'SGRSTTRule', 'SRESoundStart',
    'DISPID_SASFreeBufferSpace',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SREPropertyNumChange',
    'SpWaveFormatEx', 'SREInterference', 'STSF_LocalAppData',
    'SAFT16kHz16BitMono', 'SpeechPartOfSpeech',
    'DISPID_SRRRecoContext', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechCustomStream', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechTokenKeyUI', 'DISPID_SAVolume',
    'SpeechAudioProperties', 'SP_VISEME_6', 'SSFMOpenReadWrite',
    'SAFT12kHz8BitMono', 'SPLO_DYNAMIC', 'SBOPause',
    'DISPID_SRCPause', 'SPEI_INTERFERENCE', 'DISPID_SVPriority',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRGetPropertyString',
    'ISpeechXMLRecoResult', 'SPCT_COMMAND', 'SVP_0', 'ISpProperties',
    'ISpeechVoice', 'eWORDTYPE_ADDED', 'DISPID_SGRId',
    'ISpMMSysAudio', 'DISPID_SRCEHypothesis', 'DISPID_SVSkip',
    'SAFT32kHz16BitStereo', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SPEDisplayAttributes', 'Speech_StreamPos_Asap',
    'SRADynamic', 'SVEAllEvents', 'SPVPRI_NORMAL',
    'DISPID_SGRsCommit', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SPAStartElementInResult', 'SPSNotOverriden',
    'DISPID_SRProfile', 'SPEI_REQUEST_UI',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SREStateChange',
    'SPEI_RESERVED3', 'SpeechInterference', 'SGRSTTWildcard',
    'DISPID_SASetState', 'SAFT44kHz8BitStereo',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SREAllEvents',
    'SpeechGrammarTagWildcard', 'SpeechRegistryUserRoot',
    'SpPhoneConverter', 'SAFT16kHz8BitStereo',
    'DISPID_SpeechRecoContext', 'ISpeechObjectToken', 'SPVPRI_ALERT',
    'SRAImport', 'ISpeechMemoryStream', 'SASStop',
    'DISPID_SLAddPronunciation', 'SREHypothesis',
    'DISPID_SGRSTsCount', 'DISPID_SPPParent', 'SGRSTTWord',
    'DISPID_SABufferNotifySize', 'ISpeechLexiconPronunciations',
    'DISPID_SRCRequestedUIType', 'SP_VISEME_16', 'SVP_4', 'SVPOver',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPPChildren', 'SSTTWildcard',
    'DISPID_SLWsCount', 'SpeechGrammarTagDictation',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRRTimes',
    'DISPID_SPRuleFirstElement', 'DISPID_SGRSTransitions',
    'DISPID_SVEBookmark', 'DISPID_SpeechVoiceEvent',
    'ISpeechGrammarRules', 'SPRST_NUM_STATES', 'SVP_17',
    'DISPID_SpeechPhraseElements', 'DISPID_SOTCategory',
    'SPEI_PHRASE_START', 'DISPID_SPRuleConfidence',
    'SAFT48kHz8BitMono', 'SLOStatic', 'SpeechDisplayAttributes',
    'DISPID_SABufferInfo', 'eLEXTYPE_PRIVATE8', 'SAFTADPCM_11kHzMono',
    'SPSHORTCUTPAIRLIST', 'SSSPTRelativeToStart', 'SPEI_RESERVED1',
    '_ISpeechRecoContextEvents', 'SDTRule', 'SVP_16', 'SPBO_NONE',
    'SWTAdded', 'eLEXTYPE_PRIVATE19',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPRuleChildren',
    'DISPID_SVEViseme', 'DISPID_SPAsItem', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SDKSetBinaryValue', 'SPINTERFERENCE_NOISE',
    'SVSFVoiceMask', 'SpObjectToken', 'DISPID_SPACommit',
    'SDTAlternates', 'ISpeechRecoResult2',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SpeechAudioStatus',
    'DISPID_SPIAudioSizeTime', 'DISPID_SVRate',
    'DISPID_SVESentenceBoundary', 'DISPID_SLPPartOfSpeech',
    'SGDSInactive', 'SPEI_END_SR_STREAM',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SRGId',
    'SDA_No_Trailing_Space', 'SAFTCCITT_ALaw_44kHzStereo',
    'SASClosed', 'SpeechGrammarState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpPhrase',
    'SpCompressedLexicon', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SBSWrite', 'SpeechAddRemoveWord', 'SpeechCategoryVoices',
    'SPFM_OPEN_READWRITE', 'SAFTDefault', 'SAFTGSM610_44kHzMono',
    'SPLOADOPTIONS', 'ISpRecoGrammar2', 'SRERecognition',
    'DISPID_SRRSpeakAudio', 'SPBOOKMARKOPTIONS', 'DISPID_SLWLangId',
    'eLEXTYPE_PRIVATE20', 'SPPHRASEELEMENT', 'SAFTADPCM_11kHzStereo',
    'SGDSActiveUserDelimited', 'DISPID_SPPBRestorePhraseFromMemory',
    'SINoise', 'SVSFNLPMask', 'SPWF_SRENGINE', 'DISPID_SRAudioInput',
    'SpeechVoiceCategoryTTSRate', 'SECFIgnoreWidth', 'SRTAutopause',
    'DISPID_SOTRemove', 'SP_VISEME_9', 'DISPID_SOTGetDescription',
    'SPINTERFERENCE_TOOLOUD', 'SpeechRunState', 'SGRSTTEpsilon',
    'SpeechAllElements', 'SpeechPropertyLowConfidenceThreshold',
    'Speech_Max_Word_Length', 'DISPID_SVSLastBookmarkId',
    'eLEXTYPE_PRIVATE6', 'SVEPrivate', 'SPPHRASEPROPERTY',
    'SPBINARYGRAMMAR', 'SVSFNLPSpeakPunc', 'DISPID_SPIReplacements',
    'ISpeechPhraseInfoBuilder', 'DISPID_SREmulateRecognition',
    'SECFDefault', 'SpeechAudioVolume', 'DISPID_SpeechLexicon',
    'DISPID_SPEs_NewEnum', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRGCmdLoadFromResource', 'SPXMLRESULTOPTIONS',
    'DISPID_SWFEFormatTag', 'eLEXTYPE_PRIVATE15',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SRRAudio',
    'SVF_None', 'SPPARTOFSPEECH', 'DISPID_SCSBaseStream',
    'DISPID_SOTs_NewEnum', 'ISpeechPhraseProperty', 'SINoSignal',
    'SAFT8kHz16BitMono', 'DISPID_SPPsItem', 'SGRSTTDictation',
    'SpFileStream', 'DISPID_SLWsItem', 'ISpGrammarBuilder',
    'eLEXTYPE_PRIVATE18', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SpeechAudio', 'DISPID_SLGenerationId',
    'DISPID_SPERequiredConfidence', 'SVSFlagsAsync', 'SGDisplay',
    'STCAll', 'SPSMF_SAPI_PROPERTIES', 'SVP_13', 'SpeechVoiceEvents',
    'DISPID_SGRSTRule', 'DISPID_SpeechDataKey',
    'DISPID_SVSLastResult', 'DISPID_SpeechRecognizerStatus',
    'SAFTCCITT_uLaw_8kHzMono', 'SVSFParseAutodetect',
    'DISPID_SPPNumberOfElements', 'SpeechTokenValueCLSID',
    'SpeechEngineProperties', 'DISPID_SPEAudioTimeOffset',
    'SP_VISEME_19', 'SVP_9', 'DISPID_SGRSAddWordTransition',
    'DISPID_SpeechPhraseAlternates', 'eLEXTYPE_RESERVED8',
    'SP_VISEME_2', '_SPAUDIOSTATE', 'SpSharedRecoContext',
    'SREBookmark', 'SRADefaultToActive', 'DISPID_SGRAddState',
    'DISPID_SPPs_NewEnum', 'SGSEnabled', 'SAFTText',
    'SSFMOpenForRead', 'SPWORDPRONUNCIATION', 'ISpeechResourceLoader',
    'DISPID_SVGetVoices', 'DISPID_SOTsItem', 'SPAS_CLOSED',
    'DISPID_SPIRetainedSizeBytes', 'SITooLoud', 'DISPID_SFSClose',
    'DISPID_SVDisplayUI', 'DISPID_SPEEngineConfidence',
    'ISpeechBaseStream', 'SpeechStreamSeekPositionType',
    'ISpeechAudioBufferInfo', 'SPAR_High', 'DISPID_SRCERequestUI',
    'SpMemoryStream', 'DISPID_SpeechBaseStream',
    'DISPID_SRIsUISupported', 'ISpXMLRecoResult', 'SRAInterpreter',
    'SGDSActive', 'DISPID_SVEWord', 'SPEI_SOUND_START',
    'DISPID_SRCEEnginePrivate', 'SAFTADPCM_22kHzStereo',
    'SPEI_MIN_TTS', 'eLEXTYPE_RESERVED7', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechVoiceStatus', '_RemotableHandle', 'SpVoice',
    'SLODynamic', 'SPAS_RUN', 'SECNormalConfidence',
    'DISPID_SpeechAudioFormat', 'SPBO_PAUSE', 'DISPID_SOTCSetId',
    'SP_VISEME_14', 'SVSFParseSsml', 'SAFT22kHz8BitStereo',
    'ISpeechPhraseRule', 'SpeechMicTraining',
    'DISPID_SPEActualConfidence', 'SRERecoOtherContext',
    'DISPID_SGRSTPropertyValue', 'SpeechTokenIdUserLexicon',
    'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRRTOffsetFromStart',
    'SDKLLocalMachine', 'SWTDeleted', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPIStartTime', 'SpeechRecoContextState',
    'DISPID_SOTDisplayUI', 'DISPID_SRGCmdLoadFromObject',
    'SWPKnownWordPronounceable', 'SPINTERFERENCE', 'SPSMF_UPS',
    'DISPID_SVSPhonemeId', 'DISPID_SDKGetlongValue',
    'SAFTNonStandardFormat', 'SpCustomStream', 'SPEI_RESERVED5',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SpeechPhraseReplacement', 'SDA_Consume_Leading_Spaces',
    'eLEXTYPE_PRIVATE7', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRSetPropertyString', 'DISPID_SRGetRecognizers',
    'ISpAudio', 'ISpShortcut', 'SAFT48kHz8BitStereo',
    'SPGRAMMARWORDTYPE', 'SPAO_RETAIN_AUDIO', 'SVP_12',
    'SpeechRecoEvents', 'SPGS_ENABLED', 'SPPS_RESERVED3',
    'SpStreamFormatConverter', 'DISPID_SDKDeleteKey',
    'DISPID_SAStatus', 'DISPID_SRSAudioStatus', 'SVP_14',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SpeechGrammarRules',
    'SpInprocRecognizer', 'SP_VISEME_12',
    'SpeechEmulationCompareFlags', 'SGRSTTTextBuffer',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRCSetAdaptationData',
    'SPINTERFERENCE_NONE', 'SECFNoSpecialChars', 'SSFMCreate',
    'DISPID_SGRSTNextState', 'SECFIgnoreCase',
    ...
    'SPPS_Interjection', 'SpResourceManager', 'SAFTGSM610_11kHzMono',
    'SP_VISEME_7', 'SPSHT_Unknown', 'SPDATAKEYLOCATION',
    'DISPID_SWFEBitsPerSample', 'SPWAVEFORMATTYPE',
    'DISPIDSPTSI_ActiveOffset', 'SPCT_SLEEP', 'DISPID_SAFType',
    'SPPS_SuppressWord', 'DISPID_SpeechRecognizer',
    'DISPID_SpeechRecoResult2', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFTCCITT_uLaw_22kHzMono', 'SPSEMANTICFORMAT',
    'SVSFPurgeBeforeSpeak', 'SpStream', 'DISPID_SGRsCount',
    'SVEBookmark', 'SpeechEngineConfidence', 'SDTAll',
    'SPGS_DISABLED', 'SpeechPropertyResponseSpeed',
    'DISPID_SRCERecognitionForOtherContext',
    'ISpeechTextSelectionInformation', 'eLEXTYPE_PRIVATE2',
    'SAFT32kHz8BitMono', 'DISPID_SLGetWords', 'SpeechStreamFileMode',
    'DISPIDSPTSI', 'DISPID_SVSInputWordPosition', 'SAFT11kHz8BitMono',
    'SAFT22kHz16BitStereo', 'SPRST_INACTIVE', 'SPTEXTSELECTIONINFO',
    'SpeechWordType', 'Speech_Default_Weight', 'ISpLexicon',
    'DISPID_SPEsItem', 'SPLO_STATIC',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SRGReset',
    'SPEI_SR_PRIVATE', 'SPRS_ACTIVE', 'SPVPRIORITY',
    'DISPID_SRCERecognition', 'DISPID_SVSpeakCompleteEvent',
    'SpeechCategoryAudioOut', 'SPCT_SUB_DICTATION',
    'DISPID_SOTDataKey', 'eLEXTYPE_PRIVATE12', 'SPSEMANTICERRORINFO',
    'SPPS_Verb', 'ISpeechRecoGrammar', 'DISPID_SADefaultFormat',
    'SAFT44kHz16BitMono', 'SPSVerb', 'SpeechTokenKeyAttributes',
    'SPEVENTSOURCEINFO', 'DISPID_SWFEExtraData',
    'SpObjectTokenCategory', 'ISpeechGrammarRuleState',
    'SpeechFormatType', 'DISPID_SVEVoiceChange',
    'SpeechTokenKeyFiles', 'ISpPhoneConverter',
    'DISPID_SRCERecognizerStateChange', 'SPPS_LMA',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechBookmarkOptions',
    'SITooQuiet', 'SLTApp', 'DISPID_SpeechPhraseRules',
    'DISPID_SRRPhraseInfo', 'SAFTExtendedAudioFormat',
    'SAFTNoAssignedFormat', 'SPPS_Noun', 'SPWORDTYPE', 'SVPNormal',
    'DISPID_SAFGuid', 'SPSHT_OTHER', 'SVP_20',
    'DISPID_SLWPronunciations', 'SAFT12kHz16BitStereo',
    'DISPID_SOTCId', 'DISPID_SPCPhoneToId', 'eLEXTYPE_PRIVATE14',
    'SRAExport', 'DISPID_SPPId', 'SPBO_AHEAD',
    'SPEI_FALSE_RECOGNITION', 'SPPS_Unknown', 'DISPID_SGRSTsItem',
    'DISPID_SpeechLexiconPronunciation',
    'ISpPhoneticAlphabetSelection', 'SPEI_HYPOTHESIS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechPhoneConverter', 'SpMMAudioEnum', 'tagSTATSTG',
    'ISpeechAudio', 'DISPID_SRCEInterference', 'ISpSerializeState',
    'DISPID_SRRGetXMLErrorInfo', 'eLEXTYPE_APP', 'DISPIDSPRG',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPPEngineConfidence', 'DISPID_SVAudioOutputStream',
    'SRCS_Enabled', 'SVF_Stressed', 'SVP_21', 'SpAudioFormat',
    'DISPID_SPRuleId', 'SVPAlert', 'SPFM_NUM_MODES',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SBONone',
    'SPEI_MAX_SR', 'SVP_6', 'DISPID_SRGIsPronounceable',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRSetPropertyNumber',
    'LONG_PTR', 'SPFM_CREATE', 'eLEXTYPE_MORPHOLOGY', 'SP_VISEME_3',
    'SPEI_ADAPTATION', 'DISPID_SLPPhoneIds',
    ...
    'DISPID_SRCEBookmark', 'SpShortcut', 'ISpeechRecognizer',
    'SPCATEGORYTYPE', 'SpeechRecoProfileProperties',
    'DISPID_SPPConfidence', 'IStream', 'DISPID_SVSLastBookmark',
    'DISPID_SABIBufferSize', 'SAFTCCITT_uLaw_22kHzStereo', 'SRARoot',
    'SPEI_MAX_TTS', 'DISPID_SpeechPhraseInfo',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechPhraseElements',
    'SAFT48kHz16BitMono', 'SPEVENT',
    'DISPID_SpeechGrammarRuleStateTransition'
]

_check_version('1.2.0', 1700054001.357831)
